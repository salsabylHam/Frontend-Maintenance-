...
<template>
  <Popover>
    <PopoverTrigger as-child>
      <slot name="button" :selected-values="selectedValues" :options="props.options">
    ...
    <PopoverContent class="w-[200px] p-0" :align="align">
      <Command
        :filter-function="(list: any, term: any) => list.filter((i: any) => i.label.toLowerCase()?.includes(term))">
